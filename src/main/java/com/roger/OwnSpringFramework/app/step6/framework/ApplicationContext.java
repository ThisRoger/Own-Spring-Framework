...
import com.roger.OwnSpringFramework.app.step6.app.Step6;
import com.roger.OwnSpringFramework.app.step6.framework.annotation.Autowired;
...
public class ApplicationContext {
    ...
    public <T> T getBean(Class<T> clazz) {
        ...
        if (annotation.scope() == Scope.SINGLETON) {
            return (T) singletonBeans.computeIfAbsent(clazz, key -> createBean(implementation, clazz));
        }
